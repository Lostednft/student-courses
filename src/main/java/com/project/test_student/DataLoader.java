...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Student student0 = new Student("felipe",List.of(Course.CourseEnum.HISTORY.toCourse(), Course.CourseEnum.MATHEMATICS.toCourse()), "felipe@gmail.com", 59L);
        Student student1 = new Student("Maria", List.of(Course.CourseEnum.SCIENCE.toCourse(), Course.CourseEnum.HISTORY.toCourse()), "maria@gmail.com", 21L);
        Student student2 = new Student("Julia", List.of(Course.CourseEnum.MATHEMATICS.toCourse(), Course.CourseEnum.BIOLOGY.toCourse()), "julia@gmail.com", 40L);
